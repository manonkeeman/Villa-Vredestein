...
const Navigatie = () => {
    ...
    const ALLOW_LOGOUT_MENU = ["/studentdashboard"];
    ...
    return (
        <nav className="navigatie-container">
            ...
            <ul className="nav-links">
                ...
                <li><NavLink to="/about" className="default-link">De Vredesteiners</NavLink></li>
                <li><NavLink to="/tijdlijn" className="default-link">Tijdlijn</NavLink></li>
