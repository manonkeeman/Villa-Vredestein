...
export const OPTIES: VerblijfOptie[] = [
    ...
    },
    {
        ...
        langeBeschrijving: [
            "Onze studentenverdieping, bovenin de villa, bestaat uit gemeubileerde kamers met een gedeelde badkamer, keuken en zitruimte. Ideaal voor een tijdelijk verblijf tijdens je studie of stage.",
        ...
        vanaf: "Op aanvraag",
        kenmerken: ["Flexibele duur", "Gemeubileerd", "Inclusief internet", "Gedeelde badkamer, keuken en zitruimte", "Parkeerplaats", "Beschikbaarheid in overleg"],
        featured: true,
        afbeeldingen: [
