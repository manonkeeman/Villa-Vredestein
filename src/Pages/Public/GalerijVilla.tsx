...
const FOTOS = [
    ...
    { src: ImgFeestje,           cat: "Samenleven", caption: "Feestje Vredestein",           sub: "Maxims verjaardag in een huis dat tegen een stootje kan",
      verhaal: "Dit was nog voor het feest. Maxims verjaardag, in een huis dat tegen een stootje kan. Een avond die vanzelf uitliep op een feest. Zo is Villa Vredestein op zijn best: mensen die samenkomen, een grote danszaal, en buiten staat de tijd even stil." },
