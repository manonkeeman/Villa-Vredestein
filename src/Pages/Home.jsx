                ...
                content={
                    <div className="bento-wrapper">
                        <div className="box box1">
                            ...
                            <p>
                                Gebouwd in 1906, ademt Villa Vredestein de charme van weleer. Hoge plafonds, oude details en een ziel die je voelt zodra je binnenstapt. Maar achter die nostalgische gevel schuilt een frisse wind: een eigentijdse plek in volle ontwikkeling.
                                <br /><br />
